...
cultureShow.addEventListener("click", () => {
  shopByEvent.style.display = "none";
  const shopByCulture = document.querySelector(".shopByCulture");
  shopByCulture.style.display =
    shopByCulture.style.display === "grid" ? "none" : "grid";
});

const eventShow = document.querySelector(".eventShow");
eventShow.addEventListener("click", () => {
  shopByCulture.style.display = "none";
  shopByEvent.style.display =
    shopByEvent.style.display === "grid" ? "none" : "grid";
});
